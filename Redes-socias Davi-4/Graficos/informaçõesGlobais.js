...
async function vizualizarInformaçõesGlobais() {
    ...
    que aproximadamente <span>${pessoasConectadas} bilhões</span> estão conectadas estão conectadas em alguma rede social e
    passam em média <span>${horas} horas</span> e <span>${minutos} minutos</span> conectadas.<br>Isso significa que aproximadamente
